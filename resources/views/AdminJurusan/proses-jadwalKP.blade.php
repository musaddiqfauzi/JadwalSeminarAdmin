            ...
            <div class="col-sm-12">
				<div class="card">
					<div class="card-body">
						<form>
							<div class="row">
								<h5>Generate Jadwal Seminar Kerja Praktek</h5>
								<hr>
								<div class="col-md-8">
									<div class="row mb-3">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input2" value="KONFIGURASI MIKROTIK PADA JARINGAN SITE TO SITE VPN MENGGUNAKAN PROTOKOL SSTP (STUDI KASUS PT. ANGKASA PURA II - BANDAR UDARA INTERNASIONAL SULTAN ISKANDAR MUDA)" disabled>
										</div>
									</div>
									<div class="row mb-3">
									...
									<div class="row mb-3">
										<label for="inputPassword3" class="col-sm-3 col-form-label">Dosen Pembimbing / Ketua Seminar</label>
										<div class="col-sm-9">
											<select class="js-dosen-array col-sm-12"></select>
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputPassword3" class="col-sm-3 col-form-label">Dosen Penguji</label>
										<div class="col-sm-9">
											<select class="js-dosen-array col-sm-12"></select>
										</div>
									</div>
										...
										<label for="input2" class="col-sm-12 col-form-label">Sesi Jadwal Yang Tersedia</label>
											...
											<div class="form-check">
												...
												<label class="form-check-label" for="gridRadios2">
													Selasa, 26 Nov 2019 / 14.00 - 16.30
												</label>
											</div>
							...
							<hr>
							<a href="/kkp"><button type="button" class="btn btn-secondary has-ripple">Kembali</button></a>
							<a href="/kkp"><button type="button" class="btn btn-outline-primary has-ripple">Proses</button></a>

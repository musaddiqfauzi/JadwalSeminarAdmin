                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-6 text-end">
                                <a href="/mahasiswa-form-tambah"><button class="btn btn-success btn-sm btn-round has-ripple"><i class="feather icon-plus"></i> Tambah Data</button></a>
                                <a href="/mahasiswa-form-upload"><button class="btn btn-primary btn-sm btn-round has-ripple"><i class="feather icon-upload"></i> Upload Data</button></a>
                            </div>
                        </div>
						<hr>
                        <div class="table-responsive">
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Musaddiq Fauzi</td>
                                        <td>1504105010087</td>
                                        <td>musaddiq@mhs.unsyiah.ac.id</td>
										<td>Teknik Elektro dan Komputer</td>
                                        <td><label class="badge badge-light-success">Sudah Register</label></td>
										<td>
											<a href="/mahasiswa-form-edit">
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Dhira Yatha Bimatha Dharmavid</td>
                                        <td>1504105010046</td>
                                        <td>dharmavid@mhs.unsyiah.ac.id</td>
										<td>Teknik Elektro dan Komputer</td>
                                        <td><label class="badge badge-light-success">Sudah Register</label></td>
										<td>
											<a href="/mahasiswa-form-edit">
									...
									<tr>
                                        ...
                                        <td>Rahmadani</td>
                                        <td>1504105010005</td>
                                        <td>rahmadani@mhs.unsyiah.ac.id</td>
										<td>Teknik Elektro dan Komputer</td>
                                        <td><label class="badge badge-light-success">Sudah Register</label></td>
										<td>
											<a href="/mahasiswa-form-edit">
									...
									<tr>
                                        ...
                                        <td>M. Dwi Ardi</td>
                                        <td>1504105010002</td>
                                        <td>dwiardi@mhs.unsyiah.ac.id</td>
										<td>Teknik Elektro dan Komputer</td>
                                        <td><label class="badge badge-light-success">Sudah Register</label></td>
										<td>
											<a href="/mahasiswa-form-edit">
									...
									<tr>
                                        ...
                                        <td>-</td>
										<td>Teknik Elektro dan Komputer</td>
                                        <td><label class="badge badge-light-danger">Belum Register</label></td>
										<td>
											<a href="/mahasiswa-form-edit">
												<button type="button" class="btn btn-sm btn-info"><i class="feather icon-edit-2"></i> Edit</button>
											</a>

					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-8">
								...
								<form>
									<div class="row mb-3">
										<label for="input1" class="col-sm-3 col-form-label">Nama</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input1" value="Musaddiq Fauzi">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input3" class="col-sm-3 col-form-label">NIM</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input3" value="1504105010087">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input2" class="col-sm-3 col-form-label">Email</label>
										<div class="col-sm-9">
											<input type="email" class="form-control" id="input2" value="musaddiq@mhs.unsyiah.ac.id">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input4" class="col-sm-3 col-form-label">Jurusan</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input4" value="Teknik Elektro dan Komputer">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input4" class="col-sm-3 col-form-label">Password Recovery</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input4" value="Xyz187HJKb">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input4" class="col-sm-3 col-form-label">Status Register</label>
										<div class="col-sm-9">
											<p class="badge badge-light-success mt-2">Sudah Register</p>
										</div>
									</div>

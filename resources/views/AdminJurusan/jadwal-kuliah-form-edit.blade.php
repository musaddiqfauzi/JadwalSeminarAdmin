                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/jadwal-kuliah">Jadwal Kuliah</a></li>
            ...
            <div class="col-sm-12">
				<div class="card">
					<div class="card-body">
						<div class="row">
							<div class="col-md-8">
								<h5>Form Edit Data Jadwal Kuliah</h5>
								<hr>
								<form>
									<div class="row mb-3">
										<label for="input1" class="col-sm-3 col-form-label">Kode Mata Kuliah</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input1" value="FTT302">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input3" class="col-sm-3 col-form-label">Nama Mata Kuliah</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input3" value="TECHNOPRENEURSHIP">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input2" class="col-sm-3 col-form-label">Kelas</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input2" value="11">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputPassword3" class="col-sm-3 col-form-label">Dosen Pengajar</label>
										<div class="col-sm-9">
											<select class="js-dosen-array col-sm-12"></select>
										</div>
									</div>
									<div class="row mb-3">
										<label for="input2" class="col-sm-3 col-form-label">Ruang</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input2" value="RKTE 1">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input2" class="col-sm-3 col-form-label">Hari</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input2" value="Senin">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input2" class="col-sm-3 col-form-label">Waktu</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input2" value="8:00 - 9:40">
										</div>
									</div>
									
									<a href="/jadwal-kuliah"><button type="button" class="btn btn-secondary">Kembali</button></a>

...
<head>
    <title>Jadwal Seminar | Dosen</title>
							...
							<div class="col-md-8">
								...
								<form>
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input1" value="Dr. Ir. Rizal Munadi, MM., M.T.">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input3" class="col-sm-3 col-form-label">NIP</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input3" value="196708151993031005">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input2" class="col-sm-3 col-form-label">Email</label>
										<div class="col-sm-9">
											<input type="email" class="form-control" id="input2" value="rizal.munadi@unsyiah.ac.id">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input4" class="col-sm-3 col-form-label">Bidang</label>
										<div class="col-sm-9">

						...
						<div class="row">
							<div class="col-md-8">
								...
								<form>
									...
									<div class="row mb-3">
										<label for="input3" class="col-sm-3 col-form-label">Email</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input3" disabled>
										</div>
									</div>
									<div class="row mb-3">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input4" placeholder="(Max 10 Karakter) - Contoh : HkxI834Jhs">
										</div>
									</div>
									<div class="row mb-3">
										<label for="input4" class="col-sm-3 col-form-label">Status Register</label>
										<div class="col-sm-9">
											<p class="badge badge-light-danger mt-2">Belum Register</p>
										</div>
									</div>
